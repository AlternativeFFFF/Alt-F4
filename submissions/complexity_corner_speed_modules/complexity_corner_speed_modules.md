...
In general, you'll get more out of your raw resources if you build a lot of machines and fill them up with productivity modules because they literally give you free stuff. Speed modules are useful though when the amount of machines is limited for some reason, or when used in beacons, which don't accept productivity modules at all. There's also a few special places where speed modules fulfill an especially useful role:
