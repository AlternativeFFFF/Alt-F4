## Factorio Mod Comparison: <author>OneCruelBagel</author>
...
As you can probably tell, I’m very impressed with Space Exploration, both as a continuation of a standard vanilla game, but also as a mod with its own look and feel. There are a few things here and there that feel a little annoying, or just added to make it harder (such as the very low stack size for naquium products) but I don't feel like these seriously detract from it. The art is great too, all of the new machines are big, chunky, well animated and satisfying to watch (even if the genetics factory looks like a Christmas tree).  

![Making ion stream](ionstream.png)

And if you do want to make things a bit more complicated for yourself, I hear it integrates very nicely with Krastorio 2, which has a similar approach to Angel's. 

### Comparison

The three mods do all feel different due to their approaches. I feel like Space Exploration works very as an expansion as it has an excellent smooth difficulty curve. AngelBobs is a good choice if you want more complicated processes and something that ramps up the difficulty from the start, rather than being gentle early on! IR is definitely more difficult to progress through than vanilla, but it feels like it's more about repeating the same steps more times. Finally, a vanilla megabase is a challenge in throughput and logistics. 

Industrial Revolution has the best artwork in my opinion - practically all the machines are changed and everything looks good, fits the theme and has a clear purpose. You can also easily see the progression through the tiers. It is very closely followed by Space Exploration, however, which also looks great and has some very big machines, allowing for lots of detail and animation. AngelBobs is less impressive. The graphics are definitely sufficient, it's not ugly or problematic by any means, but it's not as stunning as the other two. 

For combat, only AngelBobs introduces new enemies, with extra tiers of biters as well as spitters with different attack types. There's no fundamental change to the combat, you simply need to make bigger and better guns to deal with the bigger and better biters. Industrial Revolution gives you shotgun turrets and more tiers of ammunition to add some variety and Space Exploration adds some new weapons as well, including plague rockets and energy beams from space. All three (and vanilla too) have a point in the early midgame where the biters are sufficiently advanced that expansion is difficult, but you eventually research your way to bigger and better weapons that reduce the biters to the logistic challenge of keeping your outposts supplied with ammo and repair packs. Space Exploration deserves a special mention here for having ways of (almost) completely wiping out biters on any given planet. 

Exploring a new modpack can be a great adventure. Space Exploration pulls this off on the grandest scale with new planets to explore (all with their own terrain types, thanks to the Alien Biomes mod) and new resources to find, plus the additional challenges of building in space. I'd put AngelBobs in second place here as there's always excitement in a longer or faster inserter, ludicrously fast exoskeletons or nuclear construction bots. There's also new ways to process the ores you've been working with so far and the daunting task of making a new type of circuit. It's a different type of exploration, but it's still great fun. Industrial Revolution also includes new ways to process resources and new toys to play with, but it didn't have quite the same excitement for me, personally. 

Replayability is an extremely important part of Factorio, with a lot of people putting in literally thousands of hours into the game. Playing vanilla allows you to come up with more efficient systems for producing the science packs, whether that's untangling your rail network, designing layouts with more beacons or building a faster smelting array and these urges to improve are what keep us coming back. When I finished AngelBobs, I had a number of ideas for things I would do differently, and was tempted to play again to try them out, but decided fairly quickly that I'd rather move on to a different mod. With Industrial Revolution, once I finished it, whilst I'm sure I could have made a more efficient factory if I'd played again, I didn't have any urge to. I'd enjoyed the game, but didn't want to play through it again. Space Exploration has a lot more flexibility, so there are already things I know I want to try on my next run (perhaps largely skipping the rockets stage of the game, or doing my ore processing in one massive central system). I already have plans to do an SE + K2 run with my friends once we've finished our current Minecraft run. 

If you want to find out how my future runs go, or see how I'm getting on with Space Exploration, please take a look at my [Youtube](https://www.youtube.com/c/LaurencePlays) and [Twitch](https://twitch.tv/laurencestreams) channels. I currently stream Space Exploration on Wednesday evenings (UK time) and release summary videos of the streams every Sunday. The channel also has our Minecraft: Dungeons, Dragons and Space Shuttles playthrough (streams Monday, videos Saturday) and GTA Manhunt runs. I also plan to take a look at Dyson Sphere Program at some point in the future. Thank you for reading and I hope you've enjoyed my impressions of these mods. 
