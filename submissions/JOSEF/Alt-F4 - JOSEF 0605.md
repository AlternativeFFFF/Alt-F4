...
This splits the building process into two different phases: Ring building (until enough Q signals are received) and cell analysis (until enough M,E,I,J signals are received).
...
Every new cell will be checked in this way. If more than 10 miners are placed, it will be dedicated to mining independent of requirements. This is definitely the „quick & dirty“ approach and could be greatly improved.
