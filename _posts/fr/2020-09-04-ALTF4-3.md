...
Donc si vous avez quelques heures à disposition ce week-end, et que vous voulez essayer de nous aider à battre le [previous record](https://www.youtube.com/watch?v=UEhPra7M-Wg) de 521 joueurs simultanés, veuillez rejoindre notre serveur à 11h UTC ce samedi 5 septembre. Vous pourrez facilement l'identifier, car ce sera le plus grand serveur en fonctionnement !

{% include countdown.html date="2020:09:05:11:00:00" %} <br/>

Les informations sur le serveur seront fournies peu avant l'heure de début dans le salon #information de notre [Red Circuit Discord](https://discord.red-circuit.org/). Pour des informations plus générales, veuillez consulter notre [website](https://red-circuit.org/events/?Operation:%20Molten%20Silicon).

## Ne cassez pas les nouveaux jouets, s'il vous plaît <author>T-A-R</author>

Le [first Alt-F4](https://alt-f4.blog/ALTF4-1/) a été une surprise excitante lorsque mon esprit têtu est allé sur factorio.com le vendredi 14 août, sachant qu'il n'y aurait pas de nouvel article FFF #361 qui m'attendait. J'ai décidé que je voulais soutenir cette initiative, et la meilleure façon de le faire était d'agir rapidement. Voici donc un rapport de terrain sur l'un des nouveaux rapports de bugs "pas-un-bug" 1.0.

La deuxième meilleure chose à faire après une fête de lancement officiel à Prague serait un bon vieux serveur multijoueur. De nombreuses fêtes de lancement ont fleuri sur le serveur de Factorio ce vendredi-là, toutes avec de nouvelles cartes et de nombreux ingénieurs du monde entier qui se sont joints à eux pour établir des bus ambitieux. Le [Big Community Games Discord](https://discord.gg/FWQWKKA) a pu atteindre son apogée avec 201 joueurs, ce qui est une bonne chose, car il faut une base solide pour pouvoir se défouler sur tous les packs de science nécessaires pour obtenir la meilleure fonctionnalité de la version 1.0. (Indice : c'est le spidertron !)
...
L'attrait principal de Editor Extensions est sa performance - elle est plusieurs ordres de grandeur plus rapide que Creative Mod. Je vais passer en revue certaines des méthodes que j'ai utilisées pour y parvenir.
...
Nous sommes toujours à la recherche de personnes qui ont quelque chose d'intéressant à partager avec la communauté de Factorio. Si c'est votre cas, rejoignez le [Discord](https://discord.gg/AsXAwyV) (ou le [GitHub project](https://github.com/AlternativeFFFF/Alt-F4)) pour commencer. Presque tous les sujets sont les bienvenus, alors n'ayez pas peur de contribuer !
