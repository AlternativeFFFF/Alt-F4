...
Si estás familiarizado con el modo multijugador de Factorio, es posible que ya estés familiarizado con estos hosts. Además de la fiesta de lanzamiento "Bienvenido a Factorio" mencionada en [Alt-F4 número 3](https://alt-f4.blog/es/ALTF4-3/#dont-break-the-new-toys-please-tar), son responsables de varios otros grandes eventos, incluido el inolvidable [Spiffing Brit run](https://www.youtube.com/watch?v=2hgvIhMkgKU).
