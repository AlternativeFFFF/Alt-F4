...
{% include video.html mp4="https://media.alt-f4.blog/5/nukes-old.mp4" alt="Escalando destrucciones utilizando bombas nucleares - explosiones vanilla"%}
{% include video.html mp4="https://media.alt-f4.blog/5/nukes-new.mp4" alt="Escalando destrucciones utilizando bombas nucleares - explosiones MIRV" %}
...
{% include video.html mp4="https://media.alt-f4.blog/5/antimatter-bomb.mp4" alt="Masiva explosión de una bomba de antimateria" %}
...
{% include video.html mp4="https://media.alt-f4.blog/5/rocket.mp4" alt="Explosión de un cohete pequeño" %}

Cartuchos de escopeta:

{% include video.html mp4="https://media.alt-f4.blog/5/shotgun-fusion.mp4" alt="Disparando escopeta con cartuchos de fusión, creando explosiones" %}
{% include video.html mp4="https://media.alt-f4.blog/5/shotgun-antimatter.mp4" alt="Disparando escopeta con cartuchos de antimateria, creando explosiones" %}

¡Incluso balas!

{% include video.html mp4="https://media.alt-f4.blog/5/bullets-fusion.mp4" alt="Hordas de biters contra balas de fusión" %}
{% include video.html mp4="https://media.alt-f4.blog/5/bullets-antimatter.mp4" alt="Gran horda de biters contra balas de antimateria" %}
...
{% include video.html mp4="https://media.alt-f4.blog/5/plasma-thrower.mp4" alt="Torreta de plasma derritiendo una horda de biters" %}
