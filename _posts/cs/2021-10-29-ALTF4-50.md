...
{% include image.html src='https://media.alt-f4.blog/ALTF4/50/biter-battle-arena.png' alt='' caption='Biter Battle aréna s izolovanými místy pro oba dva týmy' %}
...
Sedm týmů bude soutěžit v Behemoth League. Bude začínat dnes (pátek, 29. října) s tím, že hlavní událost je souboj mezi SteelAxe a GreenScience! Můžete očekávat spektakulární hru. Je to definitivně dost jiná hra než normální Factorio. Hry budou streamovány populárními streamery, a budeme oznamovat zápasy a streamy na [Twitteru](https://twitter.com/BiterBattles).
...
Od týmu BBChampions: @everLord#4340 @Firerazer#1561 @Antoine#7049 @Macou#5037. Podporováno [Francouzkou Discord Komunitou](https://discord.gg/XKAjTTmu).
