...
Abychom oslavili novou mapu legendárního tvůrce map [mewmew](https://github.com/M3wM3w) a třpytící se nový Ryzen 5 5950X od [Gerkize](https://github.com/Gerkiz), [COMFY](https://getcomfy.eu/) Factorio organizuje speciální event 1. května v 17:00 UTC. Všichni a jejich rodiny jsou pozváni, žádná nutnost odpovědět.
