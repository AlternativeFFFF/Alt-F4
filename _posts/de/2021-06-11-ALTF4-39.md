...
{% include video.html mp4='https://media.alt-f4.blog/ALTF4/39/start.mp4' alt='JOSEF‘s selbstständig expandierende Fabrik in Aktion.' caption='JOSEF, die selbstständig expandierende Fabrik: Eine Zelle nach der anderen wird analysiert und gefüllt. Wenn alle Zellen voll sind, wird ein neuer Ring gebaut.' %}
