...
## Mod Spotlight: [Realistische Fusions Waffen](https://mods.factorio.com/mod/RealisticFusionWeaponry) <author>Romner</author>

Nachdem ich den [Realistische Fusionsenergie Mod](https://mods.factorio.com/mod/RealisticFusionPower), in der Ausgabe von [letzter Woche](https://alt-f4.blog/ALTF4-4/#mod-spotlight-realistic-fusion-power-romner) vorgestellt, gemacht habe, fragte ich mich, ob es möglich ist, Fusionsenergie für etwas anderes als Stromversorgung verwenden könnte. Also, thermonukleare Bomben existieren bereits, und reine Fusionsbomben sind nur Theorie, aber ich hab sie trotzdem hinzugefügt. Ich glaube die gifs sprechen für sich:

{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/nukes-old.mp4" alt="Mit Atomraketen Zerstörung ausweiten - vanilla Explosionen"%}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/nukes-new.mp4" alt="Mit Atomraketen Zerstörung ausweiten - MIRV Explosionen" %}
...
Ich habe vor kurzer Zeit Antimaterie zu [Realistische Fusionsenergie Mod](https://mods.factorio.com/mod/RealisticFusionPower) hinzugefügt. Antimaterie kann für Stromproduktion in sehr großem Maße oder für starke Waffen verwendet werden. *Sehr* starke Waffen. (Das gif wurde verschnellert um die niedrigen UPS auszugleichen.)

{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/antimatter-bomb.mp4" alt="Massive Explosion einer Antimaterie-Bombe" %}
...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/rocket.mp4" alt="Explosion einer kleinen Rakete" %}

- Schrotflinten Hülsen:
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/shotgun-fusion.mp4" alt="Schuss einer Fusionsshotgun, resultierend in Explosionen" %}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/shotgun-antimatter.mp4" alt="Schuss einer Antimaterie-Shotgun, resultierend in Explosionen" %}

- und noch mehr Munition!
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/bullets-fusion.mp4" alt="Herde an Beißern werden mit Fusionskugeln abgeschossen" %}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/bullets-antimatter.mp4" alt="Größere Herde an Beißern werden mit Antimaterie-Kugeln abgeschossen" %}
...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/plasma-thrower.mp4" alt="Plasmawerfer schmiltzt eine Beißer Herde" %}
