...
<div class="flex medium-center">
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/nukes-old.mp4" max-width="300px" max-height="228px" alt="Escalating destructions using nukes - vanilla explosions"%}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/nukes-new.mp4" max-width="228px" max-height="228px" alt="Escalating destructions using nukes - MIRV explosions" %}
</div>
...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/antimatter-bomb.mp4" max-width="896 px" max-height="896 px" alt="Massive explosion from antimatter bomb" %}
...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/rocket.mp4" max-width="320px" max-height="320px" alt="Explosion of small rocket" %}

- shotgun shells:
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/shotgun-fusion.mp4" max-width="946px" max-height="332px" alt="Fusion shotgun firing, creating explosions" %}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/shotgun-antimatter.mp4" max-width="946px" max-height="332px" alt="Antimatter shotgun firing, creating explosions" %}

- and even bullets!
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/bullets-fusion.mp4" max-width="592px" max-height="332px" alt="Hoard of biters being shot with fusion bullets" %}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/bullets-antimatter.mp4" max-width="592px" max-height="332px" alt="Larger hoard of biters being shot with antimatter bullets" %}
...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/plasma-thrower.mp4" max-width="646px" max-height="348px" alt="Plasma thrower meltling a biter hoard" %}
