...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/nukes-old.mp4" alt="Escalating destructions using nukes - vanilla explosions"%}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/nukes-new.mp4" alt="Escalating destructions using nukes - MIRV explosions" %}
...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/antimatter-bomb.mp4" alt="Massive explosion from antimatter bomb" %}
...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/rocket.mp4" alt="Explosion of small rocket" %}

- shotgun shells:
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/shotgun-fusion.mp4" alt="Fusion shotgun firing, creating explosions" %}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/shotgun-antimatter.mp4" alt="Antimatter shotgun firing, creating explosions" %}

- and even bullets!
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/bullets-fusion.mp4" alt="Hoard of biters being shot with fusion bullets" %}
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/bullets-antimatter.mp4" alt="Larger hoard of biters being shot with antimatter bullets" %}
...
{% include video.html mp4="https://media.alt-f4.blog/ALTF4/5/plasma-thrower.mp4" alt="Plasma thrower meltling a biter hoard" %}
